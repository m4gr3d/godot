 ...
 * Finally, you must call {@link #setRenderer} to register a {@link GodotRenderer}.
 * The renderer is
...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
	...
	public void setRenderer(GodotRenderer renderer) {
		...
		GodotRenderer.RenderThread renderThread = mRenderer.getRenderThread();
	...
	public interface EGLWindowSurfaceFactory {
		 ...
		 */
		default EGLSurface createWindowSurface(EGL10 egl, EGLDisplay display,
											  EGLConfig config, SurfaceHolder surfaceHolder) {
	 ...
	 *
	 */
	public static class GLThread extends GodotRenderer.RenderThread {
		public GLThread(GodotRenderer renderer) {
			super("GLThread");
			mRenderer = renderer;
			mRequestRender = true;
